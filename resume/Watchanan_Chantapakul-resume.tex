...
\subsection{Chiang Mai University}
\descript{B.Eng. (Hons)}
\location{University Gold Medal}
...
\section{Experience}
\runsubsection{Google Products Forum}
...
\location{August 2017 – March 2018 | Computer Engineering Student (Senior Project)}
\begin{tightemize}
...
% \item Used deep-learning, NLP, and NLU techniques
\end{tightemize}
\sectionsep
...
% \begin{tightemize}
% \item Watchanan Chantapakul, Sansanee Auephanwiriyakul, Nipon Theera-Umpon, and Navadon Khunlertgit, “Person Identification from Full-Body Movement Using String Grammar Fuzzy-Possibilistic C-Medians”, Proceedings of the 2018 IEEE International Conference on Control System, Computing and Engineering, Penang, Malaysia, November 2018.
% \end{tightemize}
\sectionsep
